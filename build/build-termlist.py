...
githubBaseUri = 'https://raw.githubusercontent.com/rebipp/rs.rebipp.org.br/main/'
...
display_order = ['http://rs.rebipp.org.br/ppi/terms/Animal', 'http://rs.rebipp.org.br/ppi/terms/Plant', 'http://rs.rebipp.org.br/ppi/terms/Flower', 'http://rs.rebipp.org.br/ppi/terms/Interactin', 'http://rs.rebipp.org.br/ppi/terms/ReproductiveSuccess', 'http://rs.rebipp.org.br/ppi/terms/NectarDynamics']
display_label = ['Animal', 'Plant', 'Flower', 'Interaction', 'ReproductiveSuccess', 'NectarDynamics']
display_comments = ['','','','','','','','','','','','','','']
display_id = ['animal', 'plant', 'flower', 'interactions', 'reproductive_success', 'nectar_dynamics']
...
#column_list = ['term_localName', 'label', 'rdfs_comment', 'dcterms_description', 'examples', 'term_modified', 'term_deprecated', 'rdf_type', 'replaces_term', 'replaces1_term']
column_list = ['pref_ns_prefix', 'pref_ns_uri', 'term_localName', 'label', 'definition', 'examples', 'notes', 'term_modified', 'term_deprecated', 'rdf_type']
if vocab_type == 2:
...
for term_list in term_lists_info:
    ...
    for index,row in frame.iterrows():
        ...
        row_list = [term_list['pref_ns_prefix'], term_list['pref_ns_uri'], row['term_localName'], row['label'], row['definition'], row['usage'], row['notes'], row['term_modified'], row['term_deprecated'], row['rdf_type']]
        if vocab_type == 2:
...
decisions_df = pd.read_csv('https://raw.githubusercontent.com/rebipp/rs.rebipp.org.br/main/decisions/decisions-links.csv', na_filter=False)
